...
describe("kromaGenerationAdapter", () => {
  ...
  it("maps inspiration references to Image 2 without losing Image 1 product identity", () => {
    const request = buildGenerationTaskRequest({
      ...baseInput,
      config: {
        ...baseInput.config,
        ...
        moduleReferenceAssets: {
          inspiration_product: [
            {
              id: "replacement-product-1",
              fileName: "replacement-shirt.png",
              imageUrl: "data:image/png;base64,replacement-shirt",
            },
          ],
        },
      },
    ...
    expect(kromaRequest).toMatchObject({
      ...
      image_url: "https://cdn.example.com/product.png",
      template_image_base64: "data:image/png;base64,replacement-shirt",
      template_image_base64s: ["data:image/png;base64,replacement-shirt"],
      use_template_mode: true,
    });
